...
exports.router.post("/order-products", (0, validateMiddleware_1.validate)(ProductSchema_1.ProductsArraySchema), OrdersController_1.orderProducts);
// create new product
...
// DELETE
// delete a product
exports.router.delete("/delete-products", (0, validateMiddleware_1.validate)(ProductSchema_1.ProductsArraySchema), ProductsController_1.deleteProducts);
// delete a promotion
